...
<body>
  ...
  <img src="image\mm.jpg" alt="image\mm.jpg" width="100%" height="500" style="float: left;">
</div>
...
<div class="row">
<div class="col-lg-4 mb-4">
<div><input type="submit" name="search" class="btn btn-primary" value="Search" style="cursor:pointer; background-color:#5b2c6f;"></div>
</div>
